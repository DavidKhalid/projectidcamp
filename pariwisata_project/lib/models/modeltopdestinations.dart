...
var destinationsList = [
  topDestinations(
    placeName: 'Danau Laut Tawar',
    address: 'Dataran Tinggi Gayo, Kabupaten Aceh Tengah, Kota Takengon',
  ...
  topDestinations(
    placeName: 'Pantan Terong',
    address: 'Dataran Tinggi Gayo Takengon',
  ...
  topDestinations(
    placeName: 'Burni Telong',
    address: 'Kabupaten Bener Meriah, Aceh',
  ...
  topDestinations(
    placeName: 'Pantai Menye',
    address: 'Kecamatan Bintang',
  ...
  topDestinations(
    placeName: 'Dermaga Lukup Panalan',
    address: 'Kawasan Dedalu, Takengon',
  ...
  topDestinations(
    placeName: 'Gua Puteri Pukes',
    address: 'Kecamatan Kebayakan, Kabupaten Aceh Tengah',
  ...
  topDestinations(
    placeName: 'Air Terjun Mangaya',
    address: 'Kecamatan Bintang, Takengon, Aceh',
  ...
  topDestinations(
    placeName: 'Bur Telege',
    address: 'Kecamatan Lut Tawar, Kabupaten Aceh Tengah',
